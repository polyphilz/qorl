...
Four PostgreSQL containers on the training host, a 52-vCPU H100 instance, each with
...
This matches the container count and per-worker resources of the benchmark host's
`002-poolconf-4x8`, with CPU numbering adjusted for the training host. Guest topology
