# 014-qwen-2-4t-med-test-1cand-1rollout
...
Outputs: `outputs/014-qwen-2-4t-med-test-1cand-1rollout/<run-number>/`.
...
```bash
uv run qorl experiment run experiments/014-qwen-2-4t-med-test-1cand-1rollout --stage evaluate --split test
```
