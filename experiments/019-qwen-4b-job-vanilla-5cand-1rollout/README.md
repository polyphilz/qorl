# 019-qwen-4b-job-vanilla-5cand-1rollout
...
Outputs: `outputs/019-qwen-4b-job-vanilla-5cand-1rollout/<run-number>/`.
...
```bash
uv run --extra gpu qorl experiment run experiments/019-qwen-4b-job-vanilla-5cand-1rollout --stage evaluate --split test
```
