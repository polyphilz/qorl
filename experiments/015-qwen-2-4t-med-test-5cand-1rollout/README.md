# 015-qwen-2-4t-med-test-5cand-1rollout
...
Outputs: `outputs/015-qwen-2-4t-med-test-5cand-1rollout/<run-number>/`.
...
```bash
uv run qorl experiment run experiments/015-qwen-2-4t-med-test-5cand-1rollout --stage evaluate --split test
```
