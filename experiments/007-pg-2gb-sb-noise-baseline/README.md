...
Outputs: `outputs/007-pg-2gb-sb-noise-baseline/<run-number>/`.
...
```bash
uv run qorl experiment run experiments/007-pg-2gb-sb-noise-baseline --stage calibrate
```
