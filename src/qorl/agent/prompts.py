...
Honor the supplied turn and inspection budgets: inspect only useful facts, never repeat an identical lookup, and reserve the remaining turns for up to five candidate evaluations plus one terminal decision.
